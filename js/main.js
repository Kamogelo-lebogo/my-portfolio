...
//Code not working and I can't understand why
...
const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_avryog5', 'template_oblc1ko', '#contact_form', '7t3Xrj3rusnVCiC8e')
        .then(() => {
            // Show message
...
sr.reveal('.home-profile, .about-image', { origin: 'right' });
sr.reveal('.home-name, .home-info, about-info', { origin: 'left' });
